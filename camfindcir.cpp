...
int main(int argc, char** argv)
{
    ...
    while(1){
        ...
        HoughCircles(img_gray, circles, CV_HOUGH_GRADIENT, 1, img_gray.rows/4, 20, 50);
        ...
        for(; it!=circles.end(); ++it) {
            ...
            circle(img_pick, center, radius, cv::Scalar(0,255,255), 2);
        ...
        imshow(WINNAME, img_pick); //output
